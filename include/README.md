...
| `BuildInfo.h` | Stable wrapper around generated/local build metadata. | Includes `BuildInfo.generated.h` when present, otherwise falls back to defaults so normal builds stay clean. |
