...
int main(int, char**) {
  ...
  RUN_TEST(test_mn42_param_focus_seed_zones);
  RUN_TEST(test_mn42_param_macros_update_seed_fields);
  ...
  RUN_TEST(test_clock_transport_controller_toggles_provider_and_follow_flag);
  RUN_TEST(test_clock_transport_controller_latches_transport_gate);
  ...
  RUN_TEST(test_preset_controller_queues_and_crossfades);
  ...
  RUN_TEST(test_seed_prime_bypass_leaves_slots_empty_and_ignores_locks);
  RUN_TEST(test_seed_prime_controller_rotates_modes_and_labels);
  RUN_TEST(test_seed_prime_controller_builds_lfsr_seeds);
  RUN_TEST(test_seed_prime_controller_builds_tap_preset_and_live_seeds);
